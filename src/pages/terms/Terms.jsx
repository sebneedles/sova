...
const Terms = () => {
  document.title = 'Sova. / Terms & Conditions';
  return (
    <div className="terms">
      <MinusLogo />
      ...
      <p>
        ...
        conditions of your use of the “App SOVA” mobile application (“Mobile
      ...
      <p>
        ...
        trademarks of the Operator or its licensors. Other trademarks, service
        marks, graphics and logos used in connection with the Mobile Application
        and Services may be the trademarks of other third parties. Your use of
        the Mobile Application and Services grants you no right or license to
      ...
      <p>
        ...
        we do, we will send you an email to notify you. We may also provide
      ...
      <p>
        ...
        or use the Mobile Application and Services. This terms and conditions
        policy was created with the help of WebsitePolicies.com
      </p>
      <hr />
      <h2>Contacting us</h2>
      <p>
